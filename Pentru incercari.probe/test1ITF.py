...
chrome.find_element(By.ID, 'last-name').send_keys("Sinpetrean")
sleep(1)

chrome.find_element(By.ID, 'job-title').send_keys("Inginer")
sleep(1)
...
expected_message = chrome.find_element(By.XPATH, '/html/body/div/div')
assert expected_message == 'The form was successfully submitted!'
